    ...
    <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
      <div class="flex flex-wrap mb-24 -mx-3">
        <div class="w-full pr-2 lg:w-1/4 lg:block">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900
            ...
            <ul>
              <li class="mb-4">
                <label for="featured" class="flex items-center dark:text-gray-300">
                  ...
                  <span class="text-lg dark:text-gray-400">Feature Product</span>
                </label>
              </li>
              <li class="mb-4">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              ...
              <input type="range" wire:model.live='price_range' class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
               max="10000000000" value="100000" step="1000000">
              <div class="flex justify-between ">
                <span class="inline-block text-lg font-bold text-blue-400 ">Rp.10.000</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">Rp.10.000.000.000</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="px-3 mb-4">
            <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex dark:bg-gray-900 ">
              <div class="flex items-center justify-between">
                <select wire:model.live ="sort" name="" id="" class="block w-40 text-base bg-gray-100 cursor-pointer
