<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="container mx-auto px-4">
    ...
    <div class="flex flex-col md:flex-row gap-4">
          ...
          <table class="w-full">
            ...
            <tr wire:key='{{$item['product_id']}}'>
                ...
                <td><button wire:click='removeItem({{$item['product_id']}})'class="bg-slate-300 border-2
                 border-slate-400 rounded-lg px-3 py-1 hover:bg-red-500
                  hover:text-white hover:border-red-700">Remove</button></td>
              </tr>
            @empty
            <tr>
              <td colspan="5" class="text-center py-4  text-4xl font-semibold text-slate-500"> </td>
            </tr>
            @endforelse
      ...
      @if ($cart_items)
      <a href="/checkout" class="bg-blue-500  text-center text-white py-2 px-4 
      rounded-lg mt-4 w-full">Checkout</a>
